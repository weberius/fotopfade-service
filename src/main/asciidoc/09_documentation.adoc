...
Wenn die so erstellten html-Dateien mit eingecheckt werden, wird aktuell die Dokumentation unter https://weberius.github.io/fotopfad-service/main.html[FotopfadService] zur Verfügung gestellt.