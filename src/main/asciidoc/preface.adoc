...
Der FotopfadService ist eine Software, die zur Planung der digitalen Form der Fotopfade verwendet werden kann. Er bietet die Möglichkeit aus einer Liste von Geokoordinaten einen Pfad zu errechnen.
