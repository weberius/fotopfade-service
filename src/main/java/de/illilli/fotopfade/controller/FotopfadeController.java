...
import de.illilli.fotopfade.model.DataTable;
import de.illilli.fotopfade.model.Gallery;
import de.illilli.fotopfade.services.*;
...
public class FotopfadeController {

    private static Logger logger = LoggerFactory.getLogger(FotopfadeController.class);
